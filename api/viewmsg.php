...
<head>
	<meta charset="UTF-8">
	<title>HowIs.Me</title>
	<meta property="og:type"               content="article" />
	<meta property="og:title"              content="Who messages you most?" />
	<meta property="og:description"        content="Find out the person who send most messages with you." />
	<meta property="og:image"              content="https://howis.me/exported/<?=$id;?>.png" />
...
<body>
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="img/binoculars.png" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">HowIs.Me</div>
      
      
	  <img src="exported/<?=$id;?>.png" class="preview"></img>

      <div class="profile-card-ctr">
        <button class="profile-card__button button--blue" id="share-fb">
			<span class="icon-font">
				<svg class="icon"><use xlink:href="#icon-facebook"></use></svg>
			</span>Share on Facebook
		</button>
        <a href="/msg.html" class="profile-card__button button--orange" id="create-card">
			Create yours
		</a>
      </div>

      <div class="profile-card-social">
        <a href="https://www.facebook.com/MonokaiJsp" class="profile-card-social__item facebook" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-facebook"></use></svg>
          </span>
        </a>

        <a href="https://twitter.com/MonokaiJs" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-twitter"></use></svg>
          </span>
        </a>

        <a href="https://www.instagram.com/MonokaiJs" class="profile-card-social__item instagram" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-instagram"></use></svg>
          </span>
        </a>
        <a href="https://github.com/MonokaiJs" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-github"></use></svg>
          </span>
        </a>

        <a href="https://omfg.vn/" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
...
$( document ).ready(function() {
    //swal("Thông báo", "Hiện tại chưa thể scan được. Thằng nhà bên nó tắt cụ wifi rồi em không fix được lỗi. Mọi người thông cảm và quay lại vào ngày mai ạ. Tại 3G nó đổi IP liên tục nên cPanel nó không cho vào. Vất vả lắm em mới đăng được cái Notice này :(", "info");
    $('#share-fb').on('click', (e) => {
		FB.ui({
			method: 'feed',
			link: 'https://howis.me/view.php?id=<?=$id;?>',
			picture: 'https://howis.me/exported/<?=$id;?>.png',
			description: 'Find out who send most messages to you on Facebook.'
		});
	});
});
</script>
